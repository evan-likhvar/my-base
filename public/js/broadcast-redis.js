...
/***/ "./resources/js/broadcast/broadcast-redis.js":
/*!***************************************************!*\
  !*** ./resources/js/broadcast/broadcast-redis.js ***!
  \***************************************************/
/*! no exports provided */
...
window.io = __webpack_require__(/*! socket.io-client */ "./node_modules/socket.io-client/lib/index.js"); //console.error(window.io);
...
document.getElementById('axios-post1').addEventListener('click', function () {
  axios.post('/broadcast-redis/push-something-to-public-chanel');
}, false);
document.getElementById('axios-post2').addEventListener('click', function () {
  axios.post('/broadcast-redis/push-something-to-private-chanel');
}, false);
document.getElementById('axios-post3').addEventListener('click', function () {
  axios.post('/broadcast-redis/push-something-to-presence-chanel');
}, false);
...
module.exports = __webpack_require__(/*! /var/www/html/my-base/resources/js/broadcast/broadcast-redis.js */"./resources/js/broadcast/broadcast-redis.js");
